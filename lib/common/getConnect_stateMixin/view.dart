...
import 'package:test22/common/getConnect_stateMixin/controller.dart';

class MinxNewsView extends GetView<NewsStateMixinController> {
  const MinxNewsView({Key? key}) : super(key: key);
